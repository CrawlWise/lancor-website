    ...
    <>
      ...
      <div className="flex flex-col">
        {serviceDetails.map((svc, i) => {
          const Icon = svc.icon;
          const isDark = i % 2 === 1; // 2nd, 4th, 6th items get dark background
          const imageFirst = i % 2 === 1; // even-indexed items (2nd, 4th...) show image on the LEFT
